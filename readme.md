...
# BlackIron Command:
```
crave run --no-patch -- "curl https://raw.githubusercontent.com/Sachinpawar86/Script/refs/heads/15/blackiron.sh | bash"
```
# Los-Ext Command:
```
...
# AlphaDroid Command:
```
crave run --no-patch -- "curl https://raw.githubusercontent.com/Sachinpawar86/Script/refs/heads/15/alpha.sh | bash"
```
